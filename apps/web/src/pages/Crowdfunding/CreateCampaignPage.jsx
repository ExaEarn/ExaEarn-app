  ...
  const publishCampaign = async () => {
    ...
    try {
      ...
      await createCampaignFlow({
        ...
        minimum_pledge: minimumContribution,
        classification: fundingType === "Donation-based" ? "DONATION" : fundingType === "Reward-based" ? "REWARD" : fundingType === "Equity-based" ? "EQUITY" : "TOKEN_SALE",
        asset: "USDT",
        country,
