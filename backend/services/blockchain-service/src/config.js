...
module.exports = {
  ...
  developerRealtime: {
    authorityUrl: process.env.DEVELOPER_REALTIME_AUTHORITY_URL || 'http://localhost:8000/api/internal/developer/realtime',
    heartbeatMs: numberEnv('DEVELOPER_WS_HEARTBEAT_MS', 30000),
    authTimeoutMs: numberEnv('DEVELOPER_WS_AUTH_TIMEOUT_MS', 5000),
    maxConnectionsPerSession: numberEnv('DEVELOPER_WS_MAX_CONNECTIONS_PER_SESSION', 5),
    maxSubscriptions: numberEnv('DEVELOPER_WS_MAX_SUBSCRIPTIONS', 100),
    maxMessageBytes: numberEnv('DEVELOPER_WS_MAX_MESSAGE_BYTES', 16384),
    maxBufferedBytes: numberEnv('DEVELOPER_WS_MAX_BUFFERED_BYTES', 1048576),
    commandLimitPerMinute: numberEnv('DEVELOPER_WS_COMMANDS_PER_MINUTE', 120),
    redisChannel: process.env.DEVELOPER_WS_REDIS_CHANNEL || 'exaearn.developer.realtime',
  },
