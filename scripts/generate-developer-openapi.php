...
$schemas = [
    ...
    'SuccessResponse' => ['type' => 'object', 'required' => ['success', 'data'], 'properties' => ['success' => ['type' => 'boolean'], 'data' => ['description' => 'Endpoint-specific response payload.'], 'timestamp' => ['type' => 'integer']]],
...
$document = [
    'openapi' => '3.1.0',
    'info' => ['title' => 'ExaEarn Developer API', 'version' => '1.0.0', 'description' => 'Generated from registered ExaEarn developer routes. Restricted product status remains independent from documentation completeness.', 'license' => ['name' => 'Proprietary']],
